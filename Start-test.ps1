...
#=======================================================================
#   OSDCLOUD Image met keuzemenu (alias-vrij + null-safe)
#=======================================================================
$uselocalimage = $true
$OSDCloudDrive = Get-OSDCloudDrive
$ImageFileItem = $null   # nette init

Write-Host -ForegroundColor Green "UseLocalImage is set to: $uselocalimage"
if (-not $OSDCloudDrive) {
    Write-Warning "OSDCloudUSB niet gevonden; online image."
    $uselocalimage = $false
}
...
#=======================================================================
$Global:MyOSDCloud.Restart = $false   # wij rebooten zelf als laatste
...
# oobe.cmd (overschrijven is prima)
@'
@echo off
...
#=======================================================================
#   Reboot (laat uit tijdens debuggen)
#=======================================================================

...
Invoke-RestMethod "https://raw.githubusercontent.com/NovofermNL/OSDCloud/main/Functions/New-ComputerName.ps1" | Out-File -FilePath 'C:\Windows\Setup\scripts\New-ComputerName.ps1' -Encoding ascii -Force
